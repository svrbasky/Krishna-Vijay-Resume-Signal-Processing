...
\cvname{Krishna Vijay} % Your name
\cvjobtitle{Samayamantri} % Job title/career

\cvdate{02 January 1990} % Date of birth
\cvaddress{svrbasky@gmail.com} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{+1 702 722 4071} % Phone number
\cvsite{krishnavijaysamayamantri.com} % Personal website
...
\Education{M.S. Electrical Engineering \newline Cal State LA | 2019 | GPA 3.855/4.0

\newline \newline B.E.(Hons.) Electrical and Electronics Engineering \newline BITS Pilani | 2013 | GPA:5.37/10
...
\skills{\textbf{Languages :} C, C++, Matlab, Python 
\newline  \textbf{WebDev :} HTML, CSS, JS
\newline  Simulation :  LabVIEW, Arduino, Ansys
\newline  Design : Adobe Photoshop
\newline  Other: MS Office, Git, Adobe AE 
}
